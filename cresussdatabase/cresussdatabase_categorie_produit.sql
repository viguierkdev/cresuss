...
CREATE TABLE `categorie_produit` (
  ...
  KEY `FKocowskb3gslihkni8apfsb80a` (`produit_id`),
  KEY `FK78q3wliycsbk6hyexg302wplf` (`categorie_id`),
  CONSTRAINT `FK78q3wliycsbk6hyexg302wplf` FOREIGN KEY (`categorie_id`) REFERENCES `categorie` (`categorie_id`),
  CONSTRAINT `FKocowskb3gslihkni8apfsb80a` FOREIGN KEY (`produit_id`) REFERENCES `produit` (`produit_id`)
